...
description: "Exploring the inner psychological battle in tennis, how to overcome self-criticism, build confidence, and learn the art of relaxation and focus to unleash true ability"
...
1. **Learning how to build the clearest possible image in your mind of the result you want**
...
2. **Learning how to trust Self 2 to perform best and learn from both success and failure**
...
3. **Learning to observe with a "non-judgmental" attitude, meaning observing what's happening without just noticing how well or poorly you're doing**
...
2. Depict imagined results
3. Trust instinct
4. Observe results of change without judgment
...
1. "Non-judgment," not trying too hard, observing what's happening now, stop the self-critical mindset humans always hold, stop judging your performance as good or bad.
2. "Feel" the hitting, racket position, sound
3. "Focus" by staring at the ball, concentrating attention on breathing, shift from self-critical thinking
